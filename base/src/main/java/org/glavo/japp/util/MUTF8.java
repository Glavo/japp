...
public final class MUTF8 {
     ...
     */
    public static int charsFromByteBufferLength(ByteBuffer buffer, int offset) {
        int length = 0;
    ...
    public static void charsFromByteBuffer(char[] chars, ByteBuffer buffer, int offset) {
        int j = 0;
    ...
    /* package-private */
    public static int stringFromByteBufferMatches(ByteBuffer buffer, int offset, String string, int stringOffset) {
        // ASCII fast-path
        int limit = buffer.limit();
        int current = offset;
    ...
    public static int mutf8FromStringLength(String s) {
        int length = 0;
        int slen = s.length();
    ...
    public static void mutf8FromString(byte[] bytes, int offset, String s) {
        int j = offset;
        byte[] buffer = null;
        int slen = s.length();
